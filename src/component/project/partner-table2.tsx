...
// try lazy loading
const OrganisationTypeChart = React.lazy(() => import('./charts/organisation-type-chart'));
const OrganisationCountryChart = React.lazy(() => import('./charts/country-chart'));
const BudgetByOrganisationTypeChart = React.lazy(() => import('./charts/budget-by-organisation-type-chart'));
const BudgetByCountryChart = React.lazy(() => import('./charts/budget-and-effort-by-country-chart'));
